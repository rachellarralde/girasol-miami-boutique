      ...
      <div className="max-w-5xl mx-auto">
        <div className="flex items-start gap-6 mb-10">
          ...
          <div className="flex-1">
            <h2 className="text-2xl font-serif mb-6 text-center md:text-left">Girasol Miami Boutique</h2>
            <div className="grid md:grid-cols-3 gap-8 text-sm font-light tracking-wide text-gray-400">
              <div>
        ...
        <div className="border-t border-gray-800 pt-6 text-xs text-gray-600 uppercase tracking-widest flex items-center justify-between">
